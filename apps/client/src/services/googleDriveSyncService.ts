...
const GOOGLE_API_KEY = 'AIzaSyApeLXFfBz9-o1ePmDCPoZMYecgvl7DPkM'; // Replace with your actual API key
const CLIENT_ID = '210053403904-m7eldh2u4js5ddfo89ondk2gpvtjtrbj.apps.googleusercontent.com'; // Replace with your actual client ID
