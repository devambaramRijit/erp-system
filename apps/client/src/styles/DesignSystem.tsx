...
export const transitions = {
  ...
  colors: 'background-color, border-color, color, fill, stroke 0.15s ease-in-out',
...
export const antdTheme = {
  token: {
    ...
    colorTextBase: colors.gray[800],
    colorBgBase: colors.gray[50],
...
export const DesignSystem: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
    <div style={{
      fontFamily: typography.fontFamily,
