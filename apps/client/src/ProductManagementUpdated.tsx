    ...
    <div style={{ width: '100%' }}>
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            padding: '10px 20px',
            backgroundColor: activeTab === 'simple' ? '#f1f1f1' : 'transparent',
            border: 'none',
            borderBottom: activeTab === 'simple' ? '2px solid #9C27B0' : 'none',
            cursor: 'pointer',
            fontWeight: activeTab === 'simple' ? 'bold' : 'normal',
            color: activeTab === 'simple' ? '#9C27B0' : '#666'
          }}
        >
          Simple View
        </button>
      ...
      <div>
        ...
        {activeTab === 'advanced' && <AdvancedInventoryTab key="advanced-tab" />}
